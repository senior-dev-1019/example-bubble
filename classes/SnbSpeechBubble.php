...
EOD;
	...
	/**
	*  Check whether a user's setting bubble type is in registered types.
	* 
	...
	*/
	...
	/**
	*  Check whether a user's setting bubble subtype is in registered subtypes.
	* 
	* @param string $check_arguments
	...
	* Get type
	* 
	* Check given string is type of bubble and Get given type from users
	...
	* Get subtype
	* 
	* Check given string is subtype of bubble and Get given subtype from users
	* Make some misspellling or some spaces eliminate.
	* 
	* @param string $check_arguments
	* @return string or NULL  (valid=sb_id, invalid=NULL)
